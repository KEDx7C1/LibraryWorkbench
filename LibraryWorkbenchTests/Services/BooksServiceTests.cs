...
namespace LibraryWorkbenchTests.Services
{
    public class BooksServiceTests
    {
        ...
        {
            //Arrange
            var expectedCount = _books.Count() + 1;

            var booksServices = new BooksService(_mockBooksRepository.Object, _mockPersonsRepository.Object,
            ...
            _mockGenresRepository.Setup(a => a.GetAll())
                .Returns(new List<DimGenre> {_mapper.Map<DimGenre>(_genre1Dto)}.AsQueryable);
            //Act
        ...
        public void GetBook_ShouldReturn_BookDto()
        {
            ...
            var booksServices = new BooksService(_mockBooksRepository.Object,
        ...
        {
            //Arrange
            var expectedCount = _books.Count();
        ...
        {
            //Arrange
            var expecterCount = _books.Count();
            var firstName = _authorDto.FirstName;
            var lastName = _authorDto.LastName;
            var middleName = _authorDto.MiddleName;
        ...
        public void GetBooksByGenre_ShouldReturn_ListOfBookDto()
        {
            //Arrange
            var expecterCount = _books.Count();
            var genreName = _genre1Dto.GenreName;
            _mockBooksRepository.Setup(a => a.GetAll()).Returns(_books.AsQueryable());
            var booksServices = new BooksService(_mockBooksRepository.Object,
                _mockPersonsRepository.Object, _mockGenresRepository.Object, _mockAuthorsRepository.Object, _mapper);
            //Act
